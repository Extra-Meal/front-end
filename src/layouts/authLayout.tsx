            ...
            {isLoginPage && (
              <div>
                ...
                <p className="text-background-200 mt-2">
                  Ready to spice things up? Sign in and dive into a world of fresh picks, tasty recipes, and exclusive offers waiting just for you.
                </p>
              </div>
            )}
            {!isLoginPage && (
